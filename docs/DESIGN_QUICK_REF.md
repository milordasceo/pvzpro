...
import { 
  ...
  MetaRow,
  screenContainer, horizontalStack, verticalStack,
} from '../ui';
```
...
<View style={{ gap: 12 }}>
  ...
  <View style={{ flexDirection: 'row', gap: 8 }}>
    ...
    <Button mode="contained" style={{ flex: 1 }}>OK</Button>
  </View>
</View>
```
...
<View style={{ 
  ...
  <Label style={{ color: tokens.colors.success.dark }}>
    На смене
  </Label>
</View>
```
