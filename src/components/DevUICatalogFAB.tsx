/**
 * 🎨 Dev UI Catalog FAB - Плавающая кнопка для доступа к UI каталогу
 * 
...
interface DevUICatalogFABProps {
  /** Показывать FAB (по умолчанию только в DEV) */
  visible?: boolean;
}

export const DevUICatalogFAB = React.memo<DevUICatalogFABProps>(({ 
  visible = __DEV__ 
}) => {
      ...
      >
        ...
        >
          <MaterialCommunityIcons
            name="palette"
            size={24}
            color="#FFFFFF"  // белый цвет для иконки на primary фоне
          />
          {tapCount > 0 && (
...
DevUICatalogFAB.displayName = 'DevUICatalogFAB';
